    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public void bind(final UserModelReciepent userModelReciepent, final OnItemClickListener listener) {
            ...
            Picasso.with(context)
                    .load(Constants.IMG_URL+userModelReciepent.getProfilePicURL())
            ...
            //Picasso.with(context).load(Constants.IMG_URL+userModelReciepent.getProfilePicURL()).placeholder(R.drawable.profile_private).into(imgUserImage);
