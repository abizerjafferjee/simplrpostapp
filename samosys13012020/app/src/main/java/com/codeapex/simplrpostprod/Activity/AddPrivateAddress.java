...
//                }
    ...
    private void add_privateaddress() {
        ...
        request.setLongitude(Double.toString(latLng.longitude));
            ...
            request.setLongitude(Double.toString(22.744614));
            request.setLongitude(Double.toString(75.890427));
        }
        ...
        call.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                Log.e("ADD ADDRESS RESP:",""+response.body().toString());
                if (response.isSuccessful()) {
                    try {
                        JSONObject jsonObject = new JSONObject(new Gson().toJson(response.body()));
                        Log.e("ADD ADDRESS RESP:",""+jsonObject);
