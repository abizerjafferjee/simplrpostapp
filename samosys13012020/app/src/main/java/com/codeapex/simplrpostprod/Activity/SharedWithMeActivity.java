...
public class SharedWithMeActivity extends Fragment implements SaveUnsaveAddress,SwipeRefreshLayout.OnRefreshListener{
        ...
        textone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (publiclist.isEmpty()) {
                    ...
                    txtError.setText("Public location not found.");
                }else {
        ...
        texttwo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (privatelist.isEmpty()) {
                    recyclervieww.setVisibility(View.GONE);
                    txtError.setVisibility(View.VISIBLE);
                    txtError.setText("Location not found.");
                }else {
                    txtError.setVisibility(View.GONE);
                }
                checkList = false;
    ...
    public void onRefresh() {
        ...
        AdatperSharedWithMe _adaterFriends0 = new AdatperSharedWithMe(getActivity(), publiclist, saveInterface, listId, true);
        recyclerView.setAdapter(_adaterFriends0);
...
//==============================================GET SHARED WITH USER API=========================================//
    ...
    public void getPublicSavedAddress() {

        if (UtilityClass.isNetworkConnected(getActivity())) {

            Parser.callApi(getActivity(), "Please wait...", false, ApiClient.getClient().create(ApiInterface.class).getPublicRecievedAddressList(user_Id), new Response_Call_Back() {
                @Override
                public void getResponseFromServer(String response) {
                    Log.e("get public saved", "response :" + response);
...
//=======================================GET SHARED WITH BUSINESS API==============================================//
    ...
    public void getPrivateSavedAddress() {

        Parser.callApi(getActivity(), "Please wait...", false, ApiClient.getClient().create(ApiInterface.class).getPrivateRecievedAddressList(user_Id), new Response_Call_Back() {
            @Override
            public void getResponseFromServer(String response) {
                Log.e("get private saved", "response :" + response);
                ...
                try {
                    ...
                    if (getActivity()!=null) {
                        AdatperSharedWithMe _adaterFriends = new AdatperSharedWithMe(getActivity(), publiclist, saveInterface, listId, true);
