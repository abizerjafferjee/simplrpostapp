...
public class AdatperSharedWithMe extends RecyclerView.Adapter<AdatperSharedWithMe.Holderclass> {
    ...
    List<ModelResultPrivateAddress> publiclist;
    SaveUnsaveAddress saveInterface;
    String listId, user_Id;
    boolean removeHeart;
    SharedPreferences sharedPreferences;

    public AdatperSharedWithMe(Context applicationContext, List<ModelResultPrivateAddress> publiclist, SaveUnsaveAddress saveInterface, String listId, boolean removeHeart) {
    ...
    public Holderclass onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.shared_with_me_adapter_items, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final AdatperSharedWithMe.Holderclass viewHolder, int i) {
        ...
        viewHolder.tag.setText(publiclist.get(i).getAddress_tag());
        ...
        if (publiclist.get(i).getStreet_image()!=null && !publiclist.get(i).getStreet_image().equals("")&&!publiclist.get(i).getStreet_image().contains("address_default_image.png")) {
            if (publiclist.get(i).getAddress_tag().equals("public")) {
                Picasso.with(applicationContext).load(Constants.IMG_URL.concat(publiclist.get(i).getStreet_image().replace("uploads/", ""))).placeholder(R.drawable.image_placeholder).into(viewHolder.imagepublic);
            } else {
                Picasso.with(applicationContext).load(Constants.IMG_URL.concat(publiclist.get(i).getStreet_image().replace("uploads/", ""))).placeholder(R.drawable.image_placeholder).into(viewHolder.imagepublic);
            }
            ...
            if (publiclist.get(i).getAddress_tag().equals("public")) {
                Picasso.with(applicationContext).load(Constants.IMG_URL.concat(publiclist.get(i).getBuilding_image().replace("uploads/", ""))).placeholder(R.drawable.image_placeholder).into(viewHolder.imagepublic);
            } else {
                Picasso.with(applicationContext).load(Constants.IMG_URL.concat(publiclist.get(i).getBuilding_image().replace("uploads/", ""))).placeholder(R.drawable.image_placeholder).into(viewHolder.imagepublic);
            }
            ...
            if (publiclist.get(i).getAddress_tag().equals("public")) {
                Picasso.with(applicationContext).load(Constants.IMG_URL.concat(publiclist.get(i).getEntrance_image().replace("uploads/", ""))).placeholder(R.drawable.image_placeholder).into(viewHolder.imagepublic);
            } else {
                Picasso.with(applicationContext).load(Constants.IMG_URL.concat(publiclist.get(i).getEntrance_image().replace("uploads/", ""))).placeholder(R.drawable.image_placeholder).into(viewHolder.imagepublic);
            }
        }
        ...
        /*if (publiclist.get(i).getAddress_tag().equals("public")){
            ...
            viewHolder.unsharePublic.setVisibility(View.GONE);
        }*/

        viewHolder.unsharePublic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Parser.callApi(applicationContext, "Please wait...", true, ApiClient.getClient().create(ApiInterface.class).saveOtherUserAddress(sharedPreferences.getString(Constants.userId,""), publiclist.get(i).getAddressId(),publiclist.get(i).getAddress_tag()), new Response_Call_Back() {
                    @Override
