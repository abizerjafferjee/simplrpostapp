...
public class WelcomeActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent intent = new Intent(this, AddLocation_Activity.class);
        ...
        if (appVersionCode == savedVersionCode) {
            ...
            layoutParams.topMargin = layoutParams.topMargin + AddLocation_Activity.getStatusBarHeight(this);
