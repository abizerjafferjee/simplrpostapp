        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spinnerValue.equals("+254") && signup_contactno.getText().toString().trim().length() != 9) {
                    ...
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+251") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+256") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+234") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+213") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+244") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+267") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+237") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+233") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+258") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+212") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+250") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+221") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+216") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+263") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+225") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+220") && signup_contactno.getText().toString().trim().length() != 9) {
                    new Message().showSnack(root_lay, "Mobile number should be in 9 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+20") && signup_contactno.getText().toString().trim().length() != 10) {
                    new Message().showSnack(root_lay, "Mobile number should be in 10 digit");
                    signup_contactno.requestFocus();
                    return;
                } else if (spinnerValue.equals("+27") && signup_contactno.getText().toString().trim().length() != 10) {
                    new Message().showSnack(root_lay, "Mobile number should be in 10 digit");
                    signup_contactno.requestFocus();
                    return;
                } else {
