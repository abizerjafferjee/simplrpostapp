...
public class PublicAddress {
    ...
    public PublicAddress(String addressId, String pictureURL, String shortName, String plusCode, String categoryName, String addressReferenceId, String description) {
