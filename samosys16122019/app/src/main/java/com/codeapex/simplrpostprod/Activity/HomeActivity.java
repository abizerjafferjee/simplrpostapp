...
public class HomeActivity extends AppCompatActivity {
    ...
    ProgressBar Loader;
    TextView txt_msg_profileComplete;

    String referenceId;
    ConstraintLayout root_lay;
    SharedPreferences preferences;
    String userId, name, userName, emailId, contactNumber, dpimg, isEmailIdVerified, isContactNumberVerified , question,answer;
        ...
        if (getIntent().hasExtra("type")) {
            ...
            try {
                if (type.equals("admin")) {
                    ...
                    intent.putExtra("addressId", getIntent().getStringExtra("recipientBusinessId"));
                    intent.putExtra("isOwn",true);
                    intent.putExtra("isFromShared",true);
                    intent.putExtra("isFromNotification",true);
                    intent.putExtra("sharedAddressId",getIntent().getStringExtra("addressId"));
                    intent.putExtra("isAddressPublic",getIntent().getStringExtra("isAddressPublic"));
                    startActivity(intent);
                }
            }
   ...
   /* @Override
    ...
    //Handle the app deep link intent
    ...
    private void handleIntent() {
        ...
        if (appLinkData != null) {
            ...
            if (sharedPreferences.getBoolean(Constants.isUserLoggedIn, false) == false) {
                ...
                String addressId = appLinkData.getLastPathSegment();
//                new Message().showSnack(rootLayer, addressId);
...
//        UtilityClass.showLoading(Loader,HomeActivity.this);
