            ...
            public void onClick(View v) {
                ...
                if (hasPermissions(PERMISSIONS)) {
                    ...
                    if (Edtcontactno.getText().toString().isEmpty()) {
                        ...
                        /*Parser.callApi(SignInActivity.this, "Please wait...", true, ApiClient.getClient().create(ApiInterface.class).resend_otp(spinnerValue + Edtcontactno.getText().toString(),""), new Response_Call_Back() {
                            @Override
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == REQUEST_CODE_ASK_PERMISSIONS) {
            if (grantResults.length > 0
                ...
                Toast.makeText(SignInActivity.this, "Some Permission denied", Toast.LENGTH_SHORT).show();
                //finish();
            }
        }
    }
