...
public interface Api {
    ...
    Call<Object> signUp(@Body Map<String, String> body);
...
//    Call<List<ResultPrivateAddress>> getPrivateAddresses(@Field("userId") String userId);
 ...
 @POST(Constants.unshareAddressWithUser)
    ...
    Call<Object> addPublicAddressService(@Part MultipartBody.Part filePart, @Part("addressId")RequestBody addressId,@Part("serviceId") RequestBody serviceId);
